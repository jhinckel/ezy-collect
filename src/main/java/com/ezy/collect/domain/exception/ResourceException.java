...
public class ResourceException extends RuntimeException {
    ...
    public ResourceException(ErrorMessage errorEnum, HttpStatus httpStatus) {
    ...
    public ResourceException(ErrorMessage errorEnum, HttpStatus httpStatus, String... interpolationParams) {
        super(errorEnum.getError());
        this.errorsEnum = errorEnum;
        this.httpStatus = httpStatus;
    ...
    public ResourceException(ErrorMessage errorEnum, String... interpolationParams) {
        super(errorEnum.getError());
        this.errorsEnum = errorEnum;
